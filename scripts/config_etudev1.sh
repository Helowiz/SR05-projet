...
$CTL -n C6 -id 6 < /tmp/in_C6 > /tmp/out_C6 &
$NET -p 8085 -sp 8083 < /tmp/in_N6 > /tmp/out_N6 &
$LOG --port 5448 < /tmp/in_6 &

$APP --port 4449   -id 7 < /tmp/in_A7 > /tmp/out_A7 &
$CTL -n C7 -id 7 < /tmp/in_C7 > /tmp/out_C7 &
