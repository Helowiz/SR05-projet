...
cleanup() {
    ...
    # force kill lingering nc processes related to these ports
    lsof -ti :$PORT_C2_TO_C3 | xargs -r kill -9 2>/dev/null
    lsof -ti :$PORT_C3_TO_C1 | xargs -r kill -9 2>/dev/null
